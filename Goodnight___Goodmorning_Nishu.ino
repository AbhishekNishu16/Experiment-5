/*
Based on:
Experiment 5 Example File
DIGF 6037 Creation & Computation "Nick & Kate temperature readings"
*/
//Grace & Nishu- Reading daylight across San Francisco & India
...
const char* myID = "Nishu01";

char publishChannel[] = "Nishu";
char readChannel[] = "Grace";
...
//leds
int nishuledPins[]={2,3,5,6,9,10,11,12};
int led1Val;
int brightness;
...
void sendMessage(char channel[]) 
{
  ...
  dataToSend[JsonParamName2] = nishuDaylight;
    ...
    while (!getMessage.finished()) 
    {
        ...
        if (msg.length() > 0) 
        {
          ...
          deserializeJson(inMessage, msg); // parse the  JSON value received
           ...
           graceDaylight = inMessage[JsonParamName2]; 
